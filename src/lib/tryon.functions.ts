          ...
          content: [
            {
              type: "text",
                text: [
                  ...
                  "Output exactly ONE standard, full-frame photograph of the SAME single person from IMAGE 1, now wearing the garment from IMAGE 2.",
                  "Do not create the photo by copying, compositing, overlaying, or blending IMAGE 2 into the output. Generate a fresh photograph from scratch.",
                  ...
                  "Never duplicate, mirror, merge or add extra limbs, hands, arms, shoulders or people. Do not copy the model, mannequin, hanger, body parts, pose, or background from IMAGE 2 — take ONLY the garment's colour, print, fabric, cut and length from it.",
                  ...
                  "Output a clean high-resolution image with no text, watermark, logo, border, collage, split panels or any trace of the source images.",
